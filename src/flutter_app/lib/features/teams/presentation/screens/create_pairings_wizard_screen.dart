...
/// Wizard de creación de Parejas (`teamsPreset: pairings`, tamaño 2).
class CreatePairingsWizardScreen extends ConsumerStatefulWidget {
  const CreatePairingsWizardScreen({super.key});

  @override
  ConsumerState<CreatePairingsWizardScreen> createState() => _CreatePairingsWizardScreenState();
}

class _CreatePairingsWizardScreenState extends ConsumerState<CreatePairingsWizardScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final created = await repo.createTeamsGroup(
        ...
        teamsPreset: TeamsPreset.pairings,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(l10n.pairingsWizardTitle),
        centerTitle: true,
      ),
      body: Column(
        children: [
                  ...
                  Expanded(
                    ...
                    child: FilledButton(
                      onPressed: _page < totalSteps - 1
                          ...
                          : _submit,
                      child: Text(
                        _page < totalSteps - 1 ? l10n.next : l10n.pairingsWizardCreateCta,
                      ),
                    ),
                  ),
                ],
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            l10n.pairingsWizardOwnerNicknameLabel,
          ...
          TextField(
            ...
            decoration: InputDecoration(
              filled: true,
              fillColor: AppTheme.softCream,
              helperText: l10n.pairingsWizardOwnerNicknameHelper,
              helperMaxLines: 3,
              border: OutlineInputBorder(borderRadius: BorderRadius.circular(16)),
            ),
          ),
          const SizedBox(height: 20),
          Text(
            l10n.pairingsWizardEventOptional,
            style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w700),
          ),
          const SizedBox(height: 8),
          OutlinedButton.icon(
            ...
            label: Text(
              _eventDate == null
                  ? l10n.pairingsWizardPickEventDate
  ...
  Widget _stepOwnerParticipation(ThemeData theme, AppLocalizations l10n) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            l10n.pairingsWizardOwnerParticipatesTitle,
            style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w800),
          ),
          const SizedBox(height: 16),
          RadioListTile<bool>(
            title: Text(l10n.pairingsWizardOwnerParticipatesYes),
            value: true,
            groupValue: _ownerParticipates,
            onChanged: (v) => setState(() => _ownerParticipates = v ?? true),
          ),
          RadioListTile<bool>(
            title: Text(l10n.pairingsWizardOwnerParticipatesNo),
            value: false,
            groupValue: _ownerParticipates,
  ...
  Widget _stepReview(BuildContext context, ThemeData theme, AppLocalizations l10n) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text(
            l10n.pairingsWizardReviewTitle,
            style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w800),
          ),
          const SizedBox(height: 12),
          Text(_nameCtrl.text.trim(), style: theme.textTheme.titleSmall),
          const SizedBox(height: 8),
          Text(l10n.pairingsWizardReviewSummary),
          if (_eventDate != null) ...[
            const SizedBox(height: 8),
